    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                    ...
                    <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.4" class="dark:fill-white fill-[#292D32]"
                        ...
                        <div class="flex flex-col gap-y-3">
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-gray-200 text-sm">Transactions</p>
                                <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">{{ $transactions }}</h3>
                            </div>
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-gray-200 text-sm">Students</p>
                                <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">{{ $students }}</h3>
                            </div>
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-gray-200 text-sm">Teachers</p>
                                <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">{{ $teachers }}</h3>
                            </div>
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-gray-200 text-sm">Categories</p>
                                <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">{{ $categories }}</h3>
                            </div>
                        </div>
                    </div>
                @endrole
                ...
                @endrole
                @role('student')
                    <h3 class="text-indigo-950 dark:text-gray-200 font-bold text-2xl">Upgrade Skills Today</h3>
                    <p class="text-slate-500 dark:text-gray-200 text-base">
