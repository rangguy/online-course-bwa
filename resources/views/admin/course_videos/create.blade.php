            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">{{ $course->name }}</h3>
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">{{ $course->teacher->user->name }}</h3>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.course.add_video.save', $course->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full dark:bg-gray-700 dark:text-gray-200" type="text" name="path_video" :value="old('path_video')" required autofocus autocomplete="path_video" />
