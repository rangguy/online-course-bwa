                    ...
                    <div class="item-card flex flex-col md:flex-row gap-y-10 justify-between md:items-center">
                        <div class="flex flex-row items-center gap-x-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="text-slate-500 dark:text-gray-400 text-sm">{{ $course->category->name }}</p>
                            </div>
                        </div>
                        <div class="hidden md:flex flex-col">
                            <p class="text-slate-500 dark:text-gray-400 text-sm">Students</p>
                            <h3 class="text-indigo-950 dark:text-white text-xl font-bold">
                                {{ $course->students->count() }}</h3>
                        </div>
                        <div class="hidden md:flex flex-col">
                            <p class="text-slate-500 dark:text-gray-400 text-sm">Videos</p>
                            <h3 class="text-indigo-950 dark:text-white text-xl font-bold">
                                {{ $course->course_videos->count() }}
                            </h3>
                        </div>
                        <div class="hidden md:flex flex-col">
                            <p class="text-slate-500 dark:text-gray-400 text-sm">Teacher</p>
                            <h3 class="text-indigo-950 dark:text-white text-xl font-bold">
