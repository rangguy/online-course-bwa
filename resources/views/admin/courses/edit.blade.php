                ...
                <form method="POST" action="{{ route('admin.courses.update', $course) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col items-center">
                            <img src="{{ Storage::url($course->thumbnail) }}" alt="Course Thumbnail"
                                class="rounded-2xl object-cover w-[200px] h-[150px] shadow-md mb-4">
                        </div>
                        ...
                        <div class="relative border-2 border-gray-300 rounded-lg p-6 h-64 w-full flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 dark:border-gray-600"
                            ...
                            <input type="file" class="absolute inset-0 w-full h-full opacity-0 z-50 cursor-pointer"
                                id="thumbnail" name="thumbnail" autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_trailer"
                            class="block mt-1 w-full py-3 rounded-lg border-slate-300 dark:bg-gray-900 dark:border-gray-600 dark:text-gray-200"
                            type="text" name="path_trailer" value="{{ $course->path_trailer }}" required autofocus
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5"
                            class="border border-slate-300 rounded-xl w-full dark:bg-gray-900 dark:border-gray-600 dark:text-gray-200">{{ $course->about }}</textarea>
                        ...
                        <div class="flex flex-col gap-y-5">
                            @forelse($course->course_keypoints as $keypoint)
                                <input type="text"
                                    ...
                                    name="course_keypoints[]" value="{{ $keypoint->name }}" />
                            @empty
                            @endforelse
                        </div>
